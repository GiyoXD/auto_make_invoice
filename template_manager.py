...
def add_table_to_sheet(
    ...
    try:
        ...
        # Adjusted total calculation (removed pre_footer)
        total_table_rows = num_header_rows + num_data_rows + num_main_footer_rows + num_static_footer_rows
        ...
        # Assumes data_rows includes the static labels in the first column already
        ...
        # --- Write Pre-Footer Static Rows Removed ---
...
if __name__ == "__main__":
    ...
    for table_id, table_data in json_data['processed_tables_data'].items():
        ...
        # Removed pre_footer_static_rows as "MADE IN CAMBODIA" is now in data_rows
        footer_config = {
            ...
            'calculate_cols': [
             ...
             # 'pre_footer_rows': [], # Removed this line
            'static_rows': [ # Optional rows *after* the totals
                 [None] * num_cols, # Add empty row after totals
                 [None, None, None, "HS.CODE: 4107.XX.XX"] + [None]*(num_cols-4) # Example static row
                 ]
        }
        ...
        try:
            # Call the function (no label_data/label_order args needed)
